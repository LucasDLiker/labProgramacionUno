...
int menu()
{
    ...
    printf("3- Modificar\n");
    printf("4- Listar\n");
    printf("5- Listar todos los empleados por sector\n");
    printf("6- Ordenar por sector y nombre\n");
    printf("7- Mostrar los datos de o los empleados que mas ganan\n");
...
int ordenarPorSector(eEmpleado x[], int len, eSector sectores[], int lenSector)
{
    ...
    for(int i=0; i<len-1; i++)
    {
        ...
        {
            cargarDescripcion(sectores,lenSector, x[i].idSector, descripcionI);
            cargarDescripcion(sectores,lenSector, x[i].idSector, descripcionJ);
